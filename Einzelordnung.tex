...
\newcounter{absatz}[section] %zhler fr abstze
\newcounter{sentence}[absatz] %zhler fr stze
...
%Kopfzeile Titelseite
 \titlehead{
    \begin{tabular}[b]{c}
    \includegraphics[height=2.1cm,keepaspectratio=true]{Logo_Graustufen.jpg}\\ %fr kleine Dateien
%     \includegraphics[height=1.5cm,keepaspectratio=true]{StuRa-logo.jpg}\\ %fr grere Dateien
%    \large{\textbf{STUDENTENRAT}}
    \end{tabular}
    \hfill
    \includegraphics[height=1.7cm,keepaspectratio=true]{tu_logo_sw.pdf}
    \vskip5pt \hrule
    }
...
%berschriftenzeile auf Titelseite --> in \title muss der jeweilige titel eingefgt werden
 \vspace{3cm}
 \title{Finanzordnung\\des Studentenrates der TU Dresden}
