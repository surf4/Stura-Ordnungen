...
\addtokomafont{section}{\centering}  %  ist format fÃ¼r Paragrafen
\addtokomafont{subsection}{\centering}  %  ist format fÃ¼r AbsÃ¤tze
\renewcommand*{\raggedsection}{\centering} % sorgt fÃ¼r mittige KapitelÃ¼berschriften
...
%     \includegraphics[height=1.5cm,keepaspectratio=true]{StuRa-logo.jpg}\\ %fr grÃ¶ÃŸere Dateien
...
%berschriftenzeile auf Titelseite --> in \title muss der jeweilige titel eingefgt werden
 \vspace{3cm}
 \title{Finanzordnung\\des ä ö ü ß Studierendenrates der TU Dresden}
